...
<html>
	...
	<body>
		<div class="container">
			<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#pokemonModal">Launch demo modal</button>
		</div>
						...
						<tbody>
							<?php foreach ($pokedex as $pokemon) {
								...
								<tr>
									...
									<td><?=$pokemon->db_id;?></td>
									<td><a href="<?=$pokemon->db_id;?>" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
									<td><a href="<?=$pokemon->db_id;?>" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
								</tr>
							<?php } ?>
						</tbody>
					</table>
...
<form method="post" action="insert.php?action=insert_pokemon">
