...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<form method="post" action="function.php?action=updatePokemon">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="health" name="health" value="<?=$data['health']?>">
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="attack1" name="attack1" value="<?=$data['attack1']?>">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="attack1_damage">Damage attack 1:</label>
								<input type="text" class="form-control" id="attack1_damage" name="attack1_damage" value="<?=$data['attack1_damage']?>">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="attack2" name="attack2" value="<?=$data['attack2']?>">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="attack2_damage">Damage attack 2:</label>
								<input type="text" class="form-control" id="attack2_damage" name="attack2_damage" value="<?=$data['attack2_damage']?>">
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="weakness_multiplier" name="weakness_multiplier" value="<?=$data['weakness_multiplier']?>">
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="resistance_value" name="resistance_value" value="<?=$data['resistance_value']?>">
							</div>
						</div>
					</div>
